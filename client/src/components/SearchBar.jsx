...
const SearchBar = () => {
  ...
  return (
    ...
    <form
      ...
      className="w-full h-14 bg-transparent z-50 flex gap-3 justify-center items-center font-light text-HeadingXS lg:justify-evenly lg:text-HeadingM px-2 lg:py-5 lg:gap-0 rounded-lg"
    >
      {/* Search icon */}
