...
const movieDetail = async (req, res) => {
  try {
    ...
    // url editing
    const updatedMovieDetailUrl = movieDetailUrl.replace(
      "movie_id",
      movieId.toString()
    );
    const updatedCastMovieUrl = castMovieUrl.replace(
      "movie_id",
      movieId.toString()
    );
...
const tvDetail = async (req, res) => {
  try {
    ...
    // url editing
    const updatedTvDetailUrl = tvDetailUrl.replace(
      "series_id",
      seriesId.toString()
    );
    const updatedCastTvUrl = castTvUrl.replace(
      "series_id",
      seriesId.toString()
    );
